...
export default function HomePage() {
  ...
  const upcomingExams = exams.filter((e) => daysUntil(e.date) >= 0).slice(0, 3);
    ...
    >
      ...
      <div className="page-grid-4 mb-8">
        ...
        <StatCard
          ...
          subtitle={`${courses.reduce((s, c) => s + c.credits, 0)} credits`}
              ...
              return (
                ...
                >
                  ...
                  <div className="text-right shrink-0 ml-4">
                    <p className="text-xs text-ink-500">{formatDate(item.dueDate)}</p>
                    <Badge
                      variant={
